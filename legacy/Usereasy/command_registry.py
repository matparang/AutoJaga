...
class CommandRegistry:
    ...
    def _handle_status(self, args: str, ctx: CommandContext) -> str:
        return (
            "Show full system status. Call these tools and report "
            "EXACTLY what they return — do not fabricate numbers:\n"
            ...
            "Report each result honestly. If any returns empty/null, say so."
        )
