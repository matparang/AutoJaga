...
class StatisticalTool(Tool):
    ...
    description = (
        "Statistical analysis engine for quantitative financial assessment. "
        "CALL THIS TOOL when you need confidence intervals, hypothesis tests, or distribution analysis.\n\n"
        "Methods:\n"
        "- confidence_interval: Compute CI from data array → e.g. 95% CI for portfolio returns\n"
        "- hypothesis_test: Two-sample t-test → compare pre/post crisis returns\n"
        "- distribution_analysis: Descriptive stats + normality test → characterise return distribution\n\n"
        "Chain: Use after financial_cv to validate findings statistically, "
        "or before bayesian_reasoner to establish priors from data"
    )
    parameters = {
        "type": "object",
        "properties": {
            "method": {
                ...
                "description": (
                    "confidence_interval: needs {data: [...], confidence: 0.95}. "
                    "hypothesis_test: needs {sample1: [...], sample2: [...]}. "
                    "distribution_analysis: needs {data: [...]}."
                ),
            },
            "params": {
                "type": "object",
                "description": (
                    ...
                    "confidence_interval: {\"data\": [10.5, 11.2, 9.8, 10.1], \"confidence\": 0.95}\n"
                    "hypothesis_test: {\"sample1\": [10, 12, 11], \"sample2\": [8, 7, 9]}\n"
                    "distribution_analysis: {\"data\": [10.5, 11.2, 9.8, 10.1, 10.7]}"
                ),
            },
        },
