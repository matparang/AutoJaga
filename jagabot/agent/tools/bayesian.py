...
class BayesianTool(Tool):
    ...
    description = (
        "Bayesian reasoning engine for probabilistic analysis and belief updating. "
        "CALL THIS TOOL when computing conditional probabilities, updating crisis likelihoods "
        "with new evidence, or running causal inference networks.\n\n"
        "Methods:\n"
        "- update_belief: Single Bayes update — P(crisis|evidence) from prior + likelihood\n"
        "- sequential_update: Chain multiple evidence items for cumulative belief update\n"
        "- bayesian_network_inference: Multi-node causal network with conditional probability tables\n\n"
        "Chain: Use after early_warning to compute P(margin_call | warning_signals), "
        "feed posterior into counterfactual_sim for scenario planning"
    )
    parameters = {
        "type": "object",
        "properties": {
            "method": {
                ...
                "description": (
                    "update_belief: needs {prior, likelihood, evidence_probability}. "
                    "sequential_update: needs {prior, evidence_items: [{likelihood, evidence_prob}, ...]}. "
                    "bayesian_network_inference: needs {nodes: {name: {parents, cpt}}, query, evidence}."
                ),
            },
            "params": {
                "type": "object",
                "description": (
                    ...
                    "update_belief: {\"prior\": 0.3, \"likelihood\": 0.8, \"evidence_probability\": 0.5}\n"
                    "sequential_update: {\"prior\": 0.3, \"evidence_items\": ["
                    "{\"likelihood\": 0.8, \"evidence_prob\": 0.5}, "
                    "{\"likelihood\": 0.6, \"evidence_prob\": 0.4}]}"
                ),
            },
        },
