    ...
    def get_tool_definition(self) -> dict:
        ...
        return {
            ...
            "description": (
                ...
                "Call this when the task requires complex reasoning, "
                "calibration work, or multi-step verification. "
                "Only call when genuinely needed — Model 2 costs more."
            ),
            "parameters": {
                "preset_id": {
                    "type":        "string",
                    "enum":        ["1", "2"],
                    "description": (
                        "1 = fast/cheap (routine tasks), "
                        "2 = smart/capable (reasoning, calibration)"
                    ),
                },
                "reason": {
                    "type":        "string",
